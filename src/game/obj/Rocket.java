...
public class Rocket extends HpRender{
    ...
    public Rocket() {
        super(new HP(20,20)); // roket can box
    ...
    private double x;
    private double y;
    private final float speed = 0.8f; // orijinal deger 0.03f (roket hızı)
    ...
    public void draw(Graphics2D g2) {
        ...
        Shape shap = getRocketShap(); // getShape Yanlızca
        hpRender(g2,shap,y);
    ...
    public boolean check(int width, int height) {
        Rectangle size = getRocketShap().getBounds();
